...
[![npm](https://img.shields.io/npm/v/@taktikorg/ipsa-iste.svg)](https://www.npmjs.com/package/@taktikorg/ipsa-iste)
[![downloads](https://img.shields.io/npm/dt/@taktikorg/ipsa-iste.svg)](https://www.npmjs.com/package/@taktikorg/ipsa-iste)
[![types](https://img.shields.io/npm/types/@taktikorg/ipsa-iste.svg)](https://www.npmjs.com/package/@taktikorg/ipsa-iste)
[![licence](https://img.shields.io/github/license/mnasyrov/@taktikorg/ipsa-iste.svg)](https://github.com/taktikorg/ipsa-iste/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@taktikorg/ipsa-iste/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@taktikorg/ipsa-iste?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@taktikorg/ipsa-iste**][@taktikorg/ipsa-iste/docs]             | Core elements, state and effect management | [Docs][@taktikorg/ipsa-iste/docs], [API][@taktikorg/ipsa-iste/api]             |
| [**@taktikorg/ipsa-iste-react**][@taktikorg/ipsa-iste-react/docs] | Tooling for React.js                       | [Docs][@taktikorg/ipsa-iste-react/docs], [API][@taktikorg/ipsa-iste-react/api] |
...
```
npm install @taktikorg/ipsa-iste @taktikorg/ipsa-iste-react --save
```
...
import { useConst, useObservable, useQuery } from '@taktikorg/ipsa-iste-react';
...
[@taktikorg/ipsa-iste/docs]: packages/@taktikorg/ipsa-iste/README.md
[@taktikorg/ipsa-iste/api]: packages/@taktikorg/ipsa-iste/docs/README.md
[@taktikorg/ipsa-iste-react/docs]: packages/@taktikorg/ipsa-iste-react/README.md
[@taktikorg/ipsa-iste-react/api]: packages/@taktikorg/ipsa-iste-react/docs/README.md
